...
**Requirements**:
  ...
  - Initial Conditions:
	-   Initialize a 2 kpc × 2 kpc patch with 1,000–50,000 particles (mass ~10⁶ M_sun each), using an exponential density profile: Σ(r) = Σ_0 exp(-r/R_d), R_d = 1 kpc, total mass ~10⁹ M_sun.
  ...
  - Visualization:
      -   Use webjars to provide a javascript UI for 2D rendering of a 2 kpc × 2 kpc region (800x800 pixels).
      ...
      -   Include UI:
          ...
          - an optional overlay of the quadtree
          -   Target ≥10 FPS for 50,000 particles.
  ...
  - Constraints:
    ...
    -   Assume hardware 64 GB RAM, 16 hyperthreaded cores.
    -   Use Java 21, using records and other language features where appropriate.
    -   Use Spring Boot for web server.
    -   Use Maven for build and dependency management.
    -   Use webjars for visualization.
    -   Use a single-page web application.
    -   Use a 2D canvas for visualization.
  ...
  - Success Criteria:
    ...
    -   Interactive visualization (≥10 FPS) for 50,000 particles.
  ...
  - Implementation Guidance:
    ...
    -   Test with 1,000 particles, scale to 50,000.
